...
export const AVATAR_REWARDS = [
  {
    id: 'midsommarkrans', label: 'Midsommarkrans', cost: 100,
    unlocks: { hair: ['long08'] },
  },
  {
    id: 'nya_munnar', label: 'Nya munnar', cost: 200,
    unlocks: {
      mouth: [
        'variant01', 'variant03', 'variant04', 'variant05', 'variant06',
        ...
        'variant23', 'variant24', 'variant25', 'variant28', 'variant29',
      ],
    },
  },
  {
    id: 'bakgrundsfarg', label: 'Bakgrundsfärg', cost: 300,
    unlocks: { backgroundColor: ['dba3be', 'c0aede', 'd1d4f9', 'ffd5dc', 'ffdfbf'] },
  },
  {
    id: 'nya_ogonbryn', label: 'Nya ögonbryn', cost: 450,
    unlocks: {
      eyebrows: [
        'variant01', 'variant04', 'variant05', 'variant06', 'variant08',
        'variant09', 'variant10', 'variant11', 'variant12', 'variant14', 'variant15',
      ],
    },
  },
  {
    id: 'nya_frisyrer', label: 'Nya frisyrer', cost: 600,
    unlocks: {
      hair: [
        'long03', 'long06', 'long11', 'long13', 'long14', 'long15',
        'long16', 'long17', 'long18', 'long19', 'long20', 'long21',
        'long22', 'long23', 'long24', 'long26',
      ],
    },
  },
  {
    id: 'nya_ogon', label: 'Nya ögon', cost: 800,
    unlocks: {
      eyes: [
        'variant02', 'variant03', 'variant05', 'variant06', 'variant07',
        'variant08', 'variant09', 'variant10', 'variant12', 'variant13',
        'variant14', 'variant15', 'variant16', 'variant17', 'variant18',
        'variant20', 'variant21', 'variant22', 'variant23', 'variant24', 'variant26',
      ],
    },
  },
  {
    id: 'nya_harfarger', label: 'Nya hårfärger', cost: 1000,
    unlocks: { hairColor: ['3eac2c', '85c2c6', '592454', 'ab2a18', 'afafaf', 'dba3be'] },
  },
  {
    id: 'orhangen', label: 'Örhängen', cost: 1300,
    unlocks: { earrings: ['variant01', 'variant02', 'variant03', 'variant04', 'variant05', 'variant06'] },
  },
  {
    id: 'ansiktsdrag', label: 'Ansiktsdrag', cost: 1600,
    unlocks: { features: ['birthmark', 'blush', 'freckles', 'mustache'] },
  },
  {
    id: 'solglasogon', label: 'Solglasögon', cost: 2000,
